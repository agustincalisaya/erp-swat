...
*   **Patrones Adapter / Gateway:** Cualquier comunicación con servicios externos debe implementarse de forma obligatoria encapsulando la lógica detrás de los patrones *Adapter* o *Gateway*.
