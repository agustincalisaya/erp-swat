...
El permiso histórico `clientes:fusionar` ya no se define ni asigna en el seed: HU-C5 no realiza fusiones y ninguna ruta, pantalla o servicio lo consume. La migración de datos `20260924190000_hu_c5_desactivar_permiso_fusionar` desactiva lógicamente el permiso y sus asignaciones si existen, conservando sus filas. Sigue pendiente de revisión antes de aplicarla a cualquier base habitual o compartida.
